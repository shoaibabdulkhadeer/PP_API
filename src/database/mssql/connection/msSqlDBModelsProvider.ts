...
const msSqlDBModelsProvider = [
		...
		{
			provide: MsSqlConstants.READONLY_9BOX_POSITIONS_MODEL,
			useValue: Tbl9BoxPositions
		},
		{
			provide: MsSqlConstants.READONLY_CERTIFICATION_PROVIDER_MODEL,
			useValue: TblCertificationProvider
		},
		{
			provide: MsSqlConstants.READONLY_DEPARTMENT_MODEL,
			useValue: TblDepartment
		},
		{
			provide: MsSqlConstants.READONLY_SKILL_TAGS_MODEL,
			useValue: TblSkillTags
		}
	],
